...
import PHXGROUP from "../../assets/PHXGROUP.svg";
...
const Chat = () => {
    ...
    const [selectedGPTVersion, setSelectedGPTVersion] = useState<string>("GPT 3.5"); 


    const gptVersionOptions = [  
        { key: 'GPT 3.5', text: 'GPT 3.5' },  
        { key: 'GPT 4.0', text: 'GPT 4.0' }  
    ];  

    const handleGPTVersionChange = (_event: React.FormEvent<HTMLDivElement>, option?: IDropdownOption): void => {  
        if (option) {  
            setSelectedGPTVersion(String(option.key)); 
            console.log(selectedGPTVersion) 
        }  
    };
    const dropdownStyles: Partial<IDropdownStyles> = {  
        dropdown: { width: 150, marginLeft: 10, marginTop: 10 },  
        title: { backgroundColor: '#F3F2F1', border: 'none'},  
        caretDownWrapper: { backgroundColor: '#F3F2F1', color: '#605E5C' },  
        dropdownItem: { backgroundColor: '#F3F2F1', color: '#605E5C' },  
        dropdownItemSelected: { backgroundColor: '#EDEBE9', color: '#605E5C' },  
        //dropdownItemHover: { backgroundColor: '#EDEBE9', color: '#605E5C' },  
    };  
                ...
                <Stack horizontal className={styles.chatRoot}>
                    <div className={styles.chatContainer}>
                        ...
                        <Dropdown  
                            ...
                            selectedKey={selectedGPTVersion}  
